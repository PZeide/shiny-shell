...
namespace Shiny::Services::Weather {
  WeatherData::WeatherData(QString condition, QString icon, qreal temperature, bool isDay, QObject* parent)
      : QObject(parent), m_condition(std::move(condition)), m_icon(std::move(icon)), m_temperature(temperature),
        m_isDay(isDay) {}
