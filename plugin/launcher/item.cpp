...
LauncherItem::LauncherItem(bool isSystemIcon, QString icon, QString name, QString description,
...
bool LauncherItem::isSystemIcon() const { return m_isSystemIcon; }

QString LauncherItem::icon() const { return m_icon; }

QString LauncherItem::name() const { return m_name; }

QString LauncherItem::description() const { return m_description; }
...
bool LauncherItem::operator!=(const LauncherItem& other) const { return !(*this == other); }
...
int LauncherItemListModel::rowCount(const QModelIndex& parent) const {
    if (parent.isValid())
        return 0;
...
QHash<int, QByteArray> LauncherItemListModel::roleNames() const {
    return {
        {IsSystemIconRole, "isSystemIcon"}, {IconRole, "icon"}, {NameRole, "name"}, {DescriptionRole, "description"}};
}
...
QList<Shiny::Launcher::LauncherItem> LauncherItemListModel::items() { return m_items; }
